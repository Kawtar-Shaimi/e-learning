<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if(isset($_POST['suspendUser'])){
            ...
            $admin = new Admin();
            $admin->changeUserStatus("suspense", $id_user);
        }
    }
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-6">
            ...
            <div class='my-20 flex items-center justify-center gap-x-5'>
                <a href="./index.php" class='text-white font-bold border border-blue-600 bg-blue-300 rounded-lg p-5'>Users</a>
                                ...
                                while($row = $users->fetch_assoc()) {
                                    ...
                                    echo "<td class='flex gap-2 px-2 py-2'>
                                            ...
                                            <form method='POST'>
                                                <input type='hidden' name='csrf_token' value='". htmlspecialchars($_SESSION['csrf_token']) . "'>
                                                <input type='hidden' value='". htmlspecialchars($row["id_user"]) . "' name='id_user'>
                                                <button name='suspendUser' type='submit' class='text-orange-500 hover:text-orange-700 cursor-pointer'>
                                                    Suspension
                                                </button>
                                            </form>
                                        </td>";
