<?php
    ...
    $admin = new Admin();
    $users = $admin->getUsersByStatus("suspense");
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if(isset($_POST['activeUser'])){
            ...
            if ($role === "enseignant") {
                ...
                $admin->changeUserStatus("active", $id_user);
            }
        }
    }
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-6">
            ...
            <div class='my-20 flex items-center justify-center gap-x-5'>
                ...
                <a href="./suspendUsers.php" class='text-white font-bold border border-blue-600 bg-blue-300 rounded-lg p-5'>Suspend Users</a>
            </div>
            <div class="mt-6">
                                ...
                                while($row = $users->fetch_assoc()) {
                                    ...
                                    echo "<td class='flex gap-2 px-2 py-2'>
                                            ...
                                            <form method='POST'>
                                                <input type='hidden' name='csrf_token' value='". htmlspecialchars($_SESSION['csrf_token']) . "'>
                                                <input type='hidden' value='". htmlspecialchars($row["id_user"]) . "' name='id_user'>
                                                <input type='hidden' value='". htmlspecialchars($row["role"]) . "' name='role'>
