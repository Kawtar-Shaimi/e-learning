<?php
    ...
    $admin = new Admin();
    $users = $admin->getUsersByStatus("valide");
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if(isset($_POST['invalideUser'])){
            ...
            $admin = new Admin();
            $admin->changeUserStatus("non_valide", $id_user);
        }
    }
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-6">
            ...
            <div class='my-20 flex items-center justify-center gap-x-5'>
                ...
                <a href="./valideUsers.php" class='text-white font-bold border border-blue-600 bg-blue-300 rounded-lg p-5'>Valide Users</a>
                <a href="./nonValideUsers.php" class='text-white font-bold bg-blue-600 rounded-lg p-5 border hover:border-blue-600 hover:bg-blue-300'>Non Valide Users</a>
                                ...
                                while($row = $users->fetch_assoc()) {
                                    ...
                                    echo "<td class='flex gap-2 px-2 py-2'>
                                            ...
                                            <form method='POST'>
                                                <input type='hidden' name='csrf_token' value='". htmlspecialchars($_SESSION['csrf_token']) . "'>
                                                <input type='hidden' value='". htmlspecialchars($row["id_user"]) . "' name='id_user'>
                                                <button name='invalideUser' type='submit' class='text-orange-500 hover:text-orange-700 cursor-pointer'>
                                                    invalide
                                                </button>
                                            </form>
                                        </td>";
