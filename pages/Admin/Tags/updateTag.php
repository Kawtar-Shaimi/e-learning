...
$tags = new Tag();
$tags->setIdTag($id_tag);
$tag_infos = $tags->getTag();
        ...
        <div class="flex-1 p-6">
            ...
            <div class="mt-6 flex justify-center items-center">
               <div class="bg-white shadow-lg rounded-lg p-8 w-full max-w-xl">
                    <h1 class="text-3xl font-bold text-center text-gray-800 mb-6">Modifier un tag</h1>
                    <form method="POST">

                        <input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($_SESSION['csrf_token']); ?>">
                        <input type="hidden" name="id_tag" value="<?php if ($tag_infos) echo $tag_infos['id_tag']; ?>">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="tag_name" name="tag_name" placeholder="Entrez le nom" required
                                class="mt-2 block w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400" value="<?php if ($tag_infos) echo $tag_infos['tag_name']; ?>">
